...
class PessoasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create pessoa" do
    assert_difference("Pessoa.count") do
      post pessoas_url, params: { pessoa: { apelido: @pessoa.apelido, ativo: @pessoa.ativo, documento: @pessoa.documento, email: @pessoa.email, nome: @pessoa.nome, telefone: @pessoa.telefone } }
    end
  ...
  test "should update pessoa" do
    patch pessoa_url(@pessoa), params: { pessoa: { apelido: @pessoa.apelido, ativo: @pessoa.ativo, documento: @pessoa.documento, email: @pessoa.email, nome: @pessoa.nome, telefone: @pessoa.telefone } }
